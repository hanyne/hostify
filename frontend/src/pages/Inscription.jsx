...
const API_URL = process.env.REACT_APP_API_URL || 'https://hostify-zvms.onrender.com/api';
...
const Inscription = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'phone' && !value.startsWith('+216')) {
      return;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ nom: '', prenom: '', email: '', mot_de_passe: '', phone: '+216' });
    } catch (error) {
